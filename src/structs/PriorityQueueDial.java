...
public class PriorityQueueDial  {
    ...
    public PriorityQueueDial(int img[], int maxPriority) {
    	this(img, maxPriority, 0, false);
    }
    public PriorityQueueDial(int img[], int maxPriority, boolean isDual) {
    	this(img, maxPriority, 0, isDual);
    }
    public PriorityQueueDial(int img[], int maxPriority, int policy){
    	this(img, maxPriority, policy, false);
    }
    public PriorityQueueDial(int img[], int maxPriority, int policy, boolean isDual) {
    	vetorDDL = new NodeDDL[img.length];
    	this.img = img;
